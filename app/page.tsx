 ...
 * The Invitation Dawah portal, Sacred Heritage, and The Noble Causes added.
 * Privacy Pledge and The Collection seamlessly woven into a perfect 3x3 grid.
  ...
  return (
    <main className="w-full relative flex flex-col items-center pt-24 md:pt-[8vw] px-4 pb-12 overflow-x-hidden">
      ...
      <div className="relative z-10 w-full max-w-3xl flex flex-col items-center text-center mt-8 px-6 md:px-10">
        ...
        {/* Expanded Top Navigation Menu: Perfectly balanced 3x3 grid system */}
