    ...
    <main className="min-h-screen bg-[#FAF9F6] flex flex-col items-center pt-12 pb-24 px-6 md:px-12 font-sans text-[#051410] overflow-x-hidden">
      ...
      <div className="w-full max-w-5xl flex flex-col items-center text-center mb-20 mt-4">
         <div className="flex flex-col md:flex-row items-center gap-4 md:gap-12 mb-10">
            <p className="text-sm md:text-base font-serif text-[#051410]/70">25 June 2026</p>
            <div className="hidden md:block w-1 h-1 rounded-full bg-[#B8860B]"></div>
            <p className="text-xl md:text-2xl font-serif text-[#B8860B]">10 Muharram 1448</p>
         </div>
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <Link href="/dashboard/reflection" className="border border-[#051410]/10 rounded-[2rem] p-10 bg-white shadow-sm flex flex-col justify-center items-center text-center min-h-[300px] hover:border-[#B8860B]/30 transition-colors duration-300 cursor-pointer block">
            ...
            <div className="flex flex-col items-center gap-6 max-w-sm mx-auto">
              ...
              <div className="flex items-center justify-center gap-8 w-full bg-stone-900/50 p-4 rounded-full border border-stone-800">
                ...
                <button 
                  ...
                  className="bg-[#B8860B] text-[#051410] w-12 h-12 rounded-full flex items-center justify-center hover:scale-105 transition-transform"
                >
                  {isPlaying ? (
        ...
        {/* Hifz Audio Player Module */}
        <Link href="/dashboard/hifz" className="border border-[#051410]/10 rounded-[2rem] p-10 bg-[#EAE6DF] shadow-sm flex flex-col justify-center items-center text-center min-h-[300px] hover:border-[#B8860B]/30 transition-colors duration-300 cursor-pointer block">
